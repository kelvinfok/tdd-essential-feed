...
class LoadFeedFromRemoteUseCaseTest: XCTestCase {
    ...
    private func expect(_ sut: RemoteFeedLoader, toCompleteWith expectedResult: RemoteFeedLoader.Result, when action: (() -> Void), file: StaticString = #file, line: UInt = #line) {
        ...
        sut.load(completion: { receivedResult in
            ...
            case let (.failure(receivedError as RemoteFeedLoader.Error), .failure(unexpectedError as RemoteFeedLoader.Error)):
                XCTAssertEqual(receivedError, unexpectedError, file: file, line: line)
            default:
